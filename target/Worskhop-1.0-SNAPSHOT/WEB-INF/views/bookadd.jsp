...
<div class="container">
    ...
    <div class="col-3">
        <form:form method="post"
            ...
            <div class="mb-3"><form:input path="isbn" cssClass="form-control"/></div>
            <div class="mb-1">Tytuł:</div>
            <div class="mb-3"><form:input path="title" cssClass="form-control"/></div>
            <div class="mb-1">Autor:</div>
            <div class="mb-3"><form:input path="author" cssClass="form-control"/></div>
            <div class="mb-1">Wydawca:</div>
            <div class="mb-3"><form:input path="publisher" cssClass="form-control"/></div>
            <div class="mb-1">Typ:</div>
            <div class="mb-3"><form:input path="type" cssClass="form-control"/></div>
